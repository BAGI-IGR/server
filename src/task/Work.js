        ...
        <div>
            <div className="down-footer">
                ...
                <select className="filter" name='status' onChange={handleChange}>
                    ...
                    <option value="http://localhost:3000/unlock">Открыта</option>
                    <option value="http://localhost:3000/work" disabled>В работе</option>
                    <option value="http://localhost:3000/closed">Выполнена</option>
                </select>
                <select className="filter" onChange={handleChange}>
                    <option selected disabled value="Автор/исполнитель">Автор/исполнитель</option>
                    <option value="http://localhost:3000/author">Автор</option>
                    <option value="http://localhost:3000/assignee">Исполнитель</option>
                </select>
            ...
            <div className="location">Задачи в работе</div>
            <div className="all-tasks-status" id="all-tasks-status">
                ...
                {sort(tasks).filter(object => (object.is_active != false && object.status == "В работе"))?.map((task) => (
