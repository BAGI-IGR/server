        ...
        <div>
            <div className="down-footer">
                ...
                <select className="filter" name='status' onChange={handleChange}>
                    ...
                    <option value="http://localhost:3000/unlock" disabled>Открыта</option>
                    <option value="http://localhost:3000/work">В работе</option>
            ...
            <div className="location">Открытые задачи</div>
            <div className="all-tasks-status" id="all-tasks-status">
                ...
                {sort(tasks).filter(object => (object.is_active != false && object.status == "Открыта"))?.map((task) => (
