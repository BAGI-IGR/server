        ...
        <div>
            <div className="down-footer">
                ...
                <select className="filter" name='status' onChange={handleChange}>
                    ...
                    <option value="https://server-njsy.vercel.app/archive/work" disabled>В работе</option>
            ...
            <div className="location">Архивные задачи в работе</div>
            <div className="all-tasks-status" id="all-tasks-status">
                {sort(archive)?.filter(object => (object.is_active == false && object.status == "В работе")).map((task) => (
