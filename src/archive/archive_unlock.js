        ...
        <div>
            <div className="down-footer">
                ...
                <select className="filter" name='status' onChange={handleChange}>
                    ...
                    <option value="https://server-njsy.vercel.app/archive/unlock" disabled>Открыта</option>
                ...
                <select className="filter" onChange={handleChange}>
                    ...
                    <option value="https://server-njsy.vercel.app/archive/assignee">Исполнитель</option>
                </select>
            ...
            <div className="location">Открытые архивированые задачи</div>
            <div className="all-tasks-status" id="all-tasks-status">
                {sort(archive)?.filter(object => (object.is_active == false && object.status == "Открыта")).map((task) => (
