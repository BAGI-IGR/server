# Generated by Django 4.0.2 on 2023-02-10 09:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='./src/files/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.CharField(blank=True, default='0', max_length=3, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('belongs', models.CharField(choices=[('Задача', 'Задача'), ('Событие', 'Событие'), ('Напоминание', 'Напоминание')], default='Задача', max_length=100)),
